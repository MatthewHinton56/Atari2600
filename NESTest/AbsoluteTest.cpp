...
namespace {
	...
	TEST_F(AbsoluteTest, absBit)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iBit);
	...
	TEST_F(AbsoluteTest, absJmp)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iJmp);
	...
	TEST_F(AbsoluteTest, absSty)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iSty);
	...
	TEST_F(AbsoluteTest, absLdy)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iLdy);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
	...
	TEST_F(AbsoluteTest, absCpy)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iCpy);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
	...
	TEST_F(AbsoluteTest, absCpx)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iCpx);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
		ASSERT_EQ(instr.getGroup(), InstructionGroups::cmp);
		ASSERT_EQ(PC, 1);
	...
	TEST_F(AbsoluteTest, absOra)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iOra);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
	...
	TEST_F(AbsoluteTest, absAnd)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iAnd);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
	...
	TEST_F(AbsoluteTest, absEor)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iEor);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
	...
	TEST_F(AbsoluteTest, absAdc)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iAdc);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
	...
	TEST_F(AbsoluteTest, absSta)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iSta);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::write);
		ASSERT_EQ(instr.getGroup(), InstructionGroups::st);
		ASSERT_EQ(PC, 1);
	...
	TEST_F(AbsoluteTest, absLda)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iLda);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
		ASSERT_EQ(instr.getGroup(), InstructionGroups::ld);
		ASSERT_EQ(PC, 1);
	...
	TEST_F(AbsoluteTest, absCmp)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iCmp);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
		ASSERT_EQ(instr.getGroup(), InstructionGroups::cmp);
		ASSERT_EQ(PC, 1);
	...
	TEST_F(AbsoluteTest, absSbc)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iSbc);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
	...
	TEST_F(AbsoluteTest, absAsl)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iAsl);
	...
	TEST_F(AbsoluteTest, absRol)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iRol);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::rmw);
	...
	TEST_F(AbsoluteTest, absLsr)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iLsr);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::rmw);
	...
	TEST_F(AbsoluteTest, absRor)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iRor);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::rmw);
	...
	TEST_F(AbsoluteTest, absStx)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iStx);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::write);
		ASSERT_EQ(instr.getGroup(), InstructionGroups::st);
		ASSERT_EQ(PC, 1);
	...
	TEST_F(AbsoluteTest, absLdx)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iLdx);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::read);
		ASSERT_EQ(instr.getGroup(), InstructionGroups::ld);
		ASSERT_EQ(PC, 1);
	...
	TEST_F(AbsoluteTest, absDec)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iDec);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::rmw);
	...
	TEST_F(AbsoluteTest, absInc)
	{
		...
		ASSERT_EQ(instr.getInstrucion(), InstructionOpcodeAbsolute::iInc);
		ASSERT_EQ(instr.getType(), InstructionTypeAbsolute::rmw);
